...
describe('bookmark validation on load', () => {
  test.fails('rejects trees with dangling bookmark IDs', async () => {
    const treeId = 'dangling-bookmarks';
    ...
    const payload = {
      ...
      rootId: 'root',
      currentNodeId: 'root',
      bookmarkedNodeIds: ['missing-node'],
    };
